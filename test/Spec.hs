...
main :: IO ()
main = do
  (t1, t2, _, _) <- protoRun NilTerm undefined undefined protos
  hspec $ do
  ...
  (t1, t2, _, _) <- protoRun proto1 undefined undefined protos
  hspec $ do
  ...
  (t1, t2, _, _) <- protoRun proto2 undefined undefined protos
  hspec $ do
